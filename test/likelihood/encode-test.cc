...
TEST(Likelihood, FindUniqueValues) {
    ...
    ASSERT_EQ(likelihood_mat.shape(0), 100);
    ASSERT_EQ(likelihood_mat.shape(1), 1092 * 3);
//    ASSERT_EQ(likelihood_mat(0, 3), 0); //TODO (Yeremia): Check whats the value at this position
