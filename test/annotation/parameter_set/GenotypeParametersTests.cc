...
TEST_F(GenotypeParametersTests, GenotypeParametersConstructValues) {  // NOLINT(cert-err58-cpp)
    ...
    genie::core::parameter::annotation::BinarizationID binarization_ID =
        genie::core::parameter::annotation::BinarizationID::BIT_PLANE;
    uint8_t num_bit_plane = 2;
    genie::core::parameter::annotation::ConcatAxis concat_axis =
        genie::core::parameter::annotation::ConcatAxis::DO_NOT_CONCAT;
    ...
    genie::core::parameter::annotation::GenotypeParameters genotypeParameters(
...
TEST_F(GenotypeParametersTests, GenotypeParameterWriteRandom) {  // NOLINT(cert-err58-cpp)
    ...
    genie::core::parameter::annotation::GenotypeParameters genotypeParameters;
    genie::core::parameter::annotation::GenotypeParameters genotypeParametersCheck;
