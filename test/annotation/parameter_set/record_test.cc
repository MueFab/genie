...
TEST_F(AnnotationParameterSetTests, annotationParameterSetForvariantSite) {  // NOLINT(cert-err58-cpp)
    ...
    std::vector<genie::core::parameter::annotation::TileConfiguration> tileConfigurationArray;
    {
        ...
        genie::core::parameter::annotation::TileConfiguration tile_configuration(
    ...
    std::vector<genie::core::parameter::annotation::filterData> filters;
 ...
 //   uint8_t n_descriptors = 15;
   ...
   // uint8_t n_attributes = 20;
    ...
    for (auto item : descriptorIDlist) {
        ...
        genie::core::parameter::annotation::AlgorithmParameters algorithm_patarmeters(
            n_pars, par_ID, par_type, par_num_array_dims, par_array_dims, par_val);

        genie::core::parameter::annotation::DescriptorConfiguration descriptor(
   ...
   //     uint8_t attribute_name_len = static_cast<uint8_t>(itemName.first.length());
       ...
       // uint8_t attribute_num_array_dims = 0;
        ...
        genie::core::parameter::annotation::AttributeParameterSet attributeSet(
