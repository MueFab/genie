...
genie::core::parameter::annotation::AttributeParameterSet
RandomAnnotationEncodingParameters::randomAttributeParameterSet() {
    ...
    genie::core::parameter::annotation::AttributeParameterSet attr(
...
genie::core::parameter::annotation::AlgorithmParameters
...
genie::core::parameter::annotation::TileStructure RandomAnnotationEncodingParameters::randomTileStructure() {
    uint8_t ATCoordSize = randomU2();
    bool two_dimensional = randomBool();
    return randomTileStructure(ATCoordSize, two_dimensional);
}
genie::core::parameter::annotation::TileStructure RandomAnnotationEncodingParameters::simpleTileStructure(
...
genie::core::parameter::annotation::TileConfiguration
RandomAnnotationEncodingParameters::randomTileConfiguration(uint8_t AT_coord_size) {
    genie::core::parameter::annotation::TileParameterSettings tileParameterSettings;
    ...
    genie::core::parameter::annotation::TileStructure default_tile_structure =
    ...
    std::vector<genie::core::parameter::annotation::TileStructure> additional_tile_structure;
    ...
    return genie::core::parameter::annotation::TileConfiguration(
...
/*
genie::core::parameter::annotation::ContactMatrixParameters
RandomAnnotationEncodingParameters::randomContactMatrixParameters() {
    uint8_t num_samples = randomU8();
    std::vector<uint8_t> sample_ID_(num_samples, 0);
    for (auto& sampleID : sample_ID_) sampleID = randomU8();
    ...
    return genie::core::parameter::annotation::ContactMatrixParameters(
        num_samples, sample_ID_, sample_name, num_chrs, chr_ID_, chr_name, chr_length, interval, tile_size_,
...
genie::core::parameter::annotation::CompressorParameterSet
RandomAnnotationEncodingParameters::randomCompressorParameterSet() {
    ...
    for (auto i = 0; i < n_compressor_steps; ++i) {
        ...
        if (!use_default_pars[i])
            algorithm_parameters.push_back(genie::core::parameter::annotation::AlgorithmParameters());
    }
...
genie::core::parameter::annotation::AnnotationEncodingParameters
RandomAnnotationEncodingParameters::randomAnnotationEncodingParameters() {
    ...
    std::vector<genie::core::parameter::annotation::DescriptorConfiguration> descriptor_configuration(
        n_descriptors, genie::core::parameter::annotation::DescriptorConfiguration());

    uint8_t n_compressors = randomU8();
    std::vector<genie::core::parameter::annotation::CompressorParameterSet> compressor_parameter_set(
        n_compressors, genie::core::parameter::annotation::CompressorParameterSet());

    uint8_t n_attributes = randomU8();
    std::vector<genie::core::parameter::annotation::AttributeParameterSet> attribute_parameter_set(
        n_attributes, genie::core::parameter::annotation::AttributeParameterSet());

    return genie::core::parameter::annotation::AnnotationEncodingParameters(
...
genie::core::parameter::annotation::Record
RandomAnnotationEncodingParameters::randomAnnotationParameterSet() {
    ...
    for (auto i = 0; i <= n_aux_attribute_groups; ++i)
        tile_configuration.push_back(genie::core::parameter::annotation::TileConfiguration(AT_coord_size));
