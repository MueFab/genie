...
TEST_P(TrackDataConformanceTest, TrackDataConformancetests) {  // NOLINT(cert-err58-cpp)
    ...
    annotationGenerator.setATType(genie::core::access_unit::annotation::AnnotationType::TRACKS,
                                   subtype);

    annotationGenerator.startStream(genie::annotation::RecType::TRACK_DATA_FILE, filepath, filepath + "_output");
}
...
INSTANTIATE_TEST_SUITE_P(testallTrackDataConformance, TrackDataConformanceTest,
    ::testing::Values(
        ...
        TestParam{"/data/records/track/trfMask_bed.1000.mgrec", AnnotationSubtype::BED},
        ...
        TestParam{"/data/records/track/concat_BED_data.mgrec", AnnotationSubtype::BED},
        TestParam{"/data/records/track/concat_INT_data.mgrec", AnnotationSubtype::BED},
        TestParam{"/data/records/track/concat_WIG_data.mgrec", AnnotationSubtype::WIG}*/));
