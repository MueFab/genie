...
class TrackConformanceTest : public ::testing::TestWithParam<std::string> {
 protected:
    // Do any necessary setup for your tests here
    TrackConformanceTest() = default;

    ~TrackConformanceTest() override = default;
...
TEST_P(TrackConformanceTest, TrackConformancetests) {  // NOLINT(cert-err58-cpp)
...
INSTANTIATE_TEST_SUITE_P(testallTrackConformance, TrackConformanceTest,
                        ::testing::Values());
