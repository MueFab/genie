...
Code::Code(const std::string& _inputFileName,
...
Code::Code(const std::string& _inputFileName,
           const std::string& _outputFileName, bool testOutput)
...
Code::Code(const std::string& inputFileName, const std::string& outputFileName,
           bool testOutput, const std::string& infoFieldsFileName,
           const std::string& _rec) {
  ...
  if (rec == "geno") {
    ...
    encodeVariantSite(inputFileName, outputFileName, testOutput,
                      infoFieldsFileName);
  }
}
...
void encodeVariantSite(const std::string& _inputFileName,
                       const std::string& _outputFileName, bool testOutput,
                       const std::string& _infoFieldsFileName) {
  //------------- read input files  ------------------//
...
void encodeVariantGenotype(const std::string& _input_fpath,
  ...
  /* for (auto formatdata : datablock.attributeData) {
    ...
    arrayDims.push_back(
        std::min(BLOCK_SIZE, static_cast<uint32_t>(recs.size())));
