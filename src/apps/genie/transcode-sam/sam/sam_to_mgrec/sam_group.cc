...
void SamRecordGroup::addAlignment(genie::core::record::Record &rec, SamRecord *r1, SamRecord *r2, bool paired_end,
    ...
    if (r1 == nullptr || r2 == nullptr) {
        ...
        if ((r_avail->mate_rid == r_avail->getRID() && r_avail->mate_pos == r_avail->getPos()) || r_avail->mate_rid == -1) {
...
void SamRecordGroup::convert(std::list<genie::core::record::Record> &records, bool) {
    ...
    if (r1 && r2 && r1->getRID() != r2->getRID()) {
        genie::core::record::Record rec1(2, cls.second, r1->moveQname(), "",
                                         std::get<1>(convertFlags2Mpeg(r1->getFlag())), true);
        genie::core::record::Record rec2(2, cls.second, r2->moveQname(), "",
