...
const uint32_t MAX_READ_LEN_UREADS = 4294967290;  //!< NOT SURE IF THIS LENGTH IS SUPPORTED IN MPEG-G
...
const float STOP_CRITERIA_REORDER = 0.5;  //!< fraction of unmatched reads in last 1M for thread to give up on searching
