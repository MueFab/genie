 ...
 * @param cp Compression parameters defining the properties and settings for reordering.
 */
 ...
 *
 * @param temp_dir Path to the temporary directory used during processing.
 * @param cp Compression parameters defining the properties and settings for encoding.
 */
