...
void reorder_compress_quality_id(const std::string &temp_dir, const compression_params &cp, genie::core::ReadEncoder::QvSelector* qv_coder, genie::core::ReadEncoder::NameSelector* name_coder, genie::core::ReadEncoder::EntropySelector* entropy, std::vector<core::parameter::ParameterSet>& params);
...
void reorder_compress_id_pe(std::string *id_array, const std::string &temp_dir, const std::string &file_order_id,
                            ...
                            const std::string &file_name, const compression_params &cp, genie::core::ReadEncoder::NameSelector* name_coder, genie::core::ReadEncoder::EntropySelector* entropy, std::vector<core::parameter::ParameterSet>& params);
...
void reorder_compress_quality_pe(std::string file_quality[2], const std::string &outfile_quality,
                                 ...
                                 const std::vector<uint32_t> &block_start, const std::vector<uint32_t> &block_end,
                                 const compression_params &cp, genie::core::ReadEncoder::QvSelector* qv_coder, genie::core::ReadEncoder::EntropySelector* entropy, std::vector<core::parameter::ParameterSet>& params);
...
void reorder_compress(const std::string &file_name, const std::string &temp_dir, const uint32_t &num_reads_per_file,
                      ...
                      const uint32_t &str_array_size, uint32_t *order_array, const std::string &mode, genie::core::ReadEncoder::QvSelector* qv_coder, genie::core::ReadEncoder::NameSelector* name_coder, genie::core::ReadEncoder::EntropySelector* entropy, std::vector<core::parameter::ParameterSet>& params);
