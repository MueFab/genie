...
void reorder_compress_quality_id(const std::string &temp_dir, const compression_params &cp, util::FastqStats *stats);
...
void reorder_compress_id_pe(std::string *id_array, const std::string &temp_dir, const std::string &file_order_id,
                            ...
                            const compression_params &cp, util::FastqStats *stats);
