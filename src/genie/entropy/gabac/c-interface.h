...
typedef enum gabac_transform {
    ...
    gabac_transform_DIFF = 5,     /**< @brief Use differences between symbol values
                                     instead of symbols */
    gabac_transform_CABAC = 6     /**< @brief Entropy core based on paramcabac */
} gabac_transform;

/**
 * @brief Contains the number of expected parameter for each gabac_transform
 */
...
/**
 * @brief Binarizations for paramcabac transformation
 */
...
/**
 * @brief Context selection modes for paramcabac transformation
 */
typedef enum gabac_context_select {
    gabac_context_select_BYPASS = 0,           /**< @brief Do not use arithmetic core */
 ...
 * @param param Array of parameter for the transformation
