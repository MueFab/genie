/**
 * Copyright 2024 MPEG-G Genomic Information Representation Working Group.
 * @file json.h
 * @brief JSON utility functions
 * 
 * This file contains utility functions for working with JSON data.
 * It includes functions for parsing JSON files and extracting relevant information
 * for use in the GENIE project, particularly for handling annotation attributes.
 * The implementation may use a JSON parsing library to read and process JSON files.
 * The functions defined in this file are intended to facilitate the integration of JSON-based
 * configuration and data files into the GENIE annotation processing workflow.
 * 
 */

#ifndef SRC_GENIE_UTIL_JSON_H_
#define SRC_GENIE_UTIL_JSON_H_
