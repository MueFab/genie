...
genie::core::record::annotation_parameter_set::Record ParameterSetComposer::Build(
    ...
    descriptor_configuration.emplace_back(genie::core::record::annotation_parameter_set::DescriptorConfiguration(
        descriptor_ID, genie::core::AlgoID::BSC, genotypeParameters, likelihoodParameters, BSCalgorithmParameters));
...
genie::core::record::annotation_parameter_set::Record ParameterSetComposer::Build(uint8_t _AT_ID, std::map<std::string, genie::core::record::annotation_parameter_set::AttributeData>& info, genie::genotype::GenotypeParameters& genotypeParameters, genie::likelihood::LikelihoodParameters likelihoodParameters, genie::annotation::Compressor& compressors, uint64_t defaultTileSize)
{
    uint8_t parameter_set_ID = 1;
    uint8_t AT_ID = _AT_ID;
    genie::core::AlphabetID AT_alphabet_ID = genie::core::AlphabetID::ACGTN;
