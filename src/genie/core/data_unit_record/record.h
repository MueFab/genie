...
#ifndef SRC_GENIE_CORE_DATA_UNIT_RECORD_RECORD_H_
#define SRC_GENIE_CORE_DATA_UNIT_RECORD_RECORD_H_
...
class Record {
 private:
    ...
    annotation_access_unit::Record annotation_access_unit_;
    annotation_parameter_set::Record annotation_parameter_set_;
...
#endif  // SRC_GENIE_CORE_DATA_UNIT_RECORD_RECORD_H_
