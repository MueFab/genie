...
#ifndef SRC_GENIE_CORE_PARAMETER_ANNOTATION_CONTACT_MATRIX_PARAMETERS_H_
#define SRC_GENIE_CORE_PARAMETER_ANNOTATION_CONTACT_MATRIX_PARAMETERS_H_
...
#endif  // SRC_GENIE_CORE_PARAMETER_ANNOTATION_CONTACT_MATRIX_PARAMETERS_H_
