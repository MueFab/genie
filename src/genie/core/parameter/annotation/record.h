...
#ifndef SRC_GENIE_CORE_PARAMETER_ANNOTATION_RECORD_H_
#define SRC_GENIE_CORE_PARAMETER_ANNOTATION_RECORD_H_
...
#endif  // SRC_GENIE_CORE_PARAMETER_ANNOTATION_RECORD_H_
