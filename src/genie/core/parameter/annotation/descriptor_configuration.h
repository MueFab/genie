...
#ifndef SRC_GENIE_CORE_PARAMETER_ANNOTATION_DESCRIPTOR_CONFIGURATION_H_
#define SRC_GENIE_CORE_PARAMETER_ANNOTATION_DESCRIPTOR_CONFIGURATION_H_
...
#endif  // SRC_GENIE_CORE_PARAMETER_ANNOTATION_DESCRIPTOR_CONFIGURATION_H_
