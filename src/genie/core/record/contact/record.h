...
#ifndef SRC_GENIE_CORE_RECORD_CONTACT_RECORD_H_
#define SRC_GENIE_CORE_RECORD_CONTACT_RECORD_H_
...
class ContactRecord {
 private:
    ...
    std::optional<linked::Record> link_record_;
...
#endif  // SRC_GENIE_CORE_RECORD_CONTACT_RECORD_H_
