...
void VariantGenotype::SetFormat(std::vector<format_field> value) { format_ = value; }
...
void VariantGenotype::SetAlleles(std::vector<std::vector<int8_t>> value) { alleles_ = value; }
...
void VariantGenotype::SetPhasings(std::vector<std::vector<uint8_t>> value) { phasings_ = value; }
...
void VariantGenotype::SetLikelihoods(std::vector<std::vector<uint32_t>> value) { likelihoods_ = value; }
