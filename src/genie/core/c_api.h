...
struct genie_SimpleSegmentStatistics {
    ...
    uint64_t segmentLength[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */          /*!< @brief */
    uint64_t mappedStrandSegmentDistribution[genie_Strand::genie_Strand_COUNT]; /* NOLINT */          /*!< @brief */
    uint64_t properlyPairedNumber;                                                                    /*!< @brief */
    uint64_t mappedStrandPairDistribution[genie_StrandPaired::genie_StrandPaired_COUNT]; /* NOLINT */ /*!< @brief */
    uint64_t maxAlignments;                                                                           /*!< @brief */
    uint64_t* multipleAlignmentSegmentDistribution; /*!< @brief [maxAlignments + 1] */
    uint64_t coverage[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */              /*!< @brief */
    uint64_t weightedCoverage[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */      /*!< @brief */
    uint64_t errorsNumber[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */          /*!< @brief */
    uint64_t substitutionsNumber[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */   /*!< @brief */
    uint64_t insertionsNumber[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */      /*!< @brief */
    uint64_t insertionsLength[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */      /*!< @brief */
    uint64_t deletionsNumber[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */       /*!< @brief */
    uint64_t deletionsLength[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */       /*!< @brief */
    uint64_t splicesNumber[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */         /*!< @brief */
    uint64_t splicesLength[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */         /*!< @brief */
    uint64_t alignmentScore[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */        /*!< @brief */
    uint64_t classSegmentDistribution[genie_RecordClass::genie_RecordClass_COUNT]; /* NOLINT */      /*!< @brief */
    uint64_t clippedSegmentDistribution[genie_ClipTypeCombination::genie_ClipTypeCombination_COUNT]; /* NOLINT */
    /*!< @brief */
...
struct genie_ExtendedSegmentStatistics {
    ...
    uint64_t* substitutionsTransitionDistribution[genie_AlphabetACGNT::genie_AlphabetACGNT_COUNT]
                                                 [genie_AlphabetACGNT::genie_AlphabetACGNT_COUNT]; /* NOLINT */
    ...
    uint64_t* splicesNumberDistribution[genie_Strand::genie_Strand_COUNT]; /* NOLINT */
    /*!< @brief [splicesNumber[1] + 1], */
    uint64_t* splicesLengthDistribution[genie_Strand::genie_Strand_COUNT]; /* NOLINT */
    /*!< @brief [splicesLength[1] + 1], */
    uint64_t* splicesPositionDistribution[genie_Strand::genie_Strand_COUNT]; /* NOLINT */
                                                                             /*!< @brief [segmentLength[1]], */
    uint64_t* alignmentScoreValueDistribution;                               /*!< @brief [alignmentScore[1] + 1] */
    uint64_t* alignmentScoreSegmentLengthDistribution[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */
    /*!< @brief [segmentLength[1]], */
    uint64_t* basesPositionDistribution[genie_AlphabetACGNT::genie_AlphabetACGNT_COUNT];
    ...
    uint64_t* qualityScorePositionDistribution[genie_StatisticsIndex::genie_StatisticsIndex_COUNT]; /* NOLINT */
    /*!< @brief [segmentLength[1]] */
    uint64_t* qualityScorePositionPercentilesDistribution[genie_PhredBins::genie_PhredBins_COUNT]; /* NOLINT */
    /*!< @brief [segmentLength[1]], */
};
...
struct genie_AdvancedSegmentStatistics {
    genie_SimpleSegmentStatistics simpleStatistics[genie_StrandStrict::genie_StrandStrict_COUNT]; /* NOLINT */
    /*!< @brief */
    genie_ExtendedSegmentStatistics extendedStatistics[genie_StrandStrict::genie_StrandStrict_COUNT]; /* NOLINT */
    /*!< @brief */
};
...
struct genie_SimpleFilter {
    ...
    bool classID[genie_RecordClass::genie_RecordClass_COUNT]; /* NOLINT */            /*!< @brief */
    uint64_t sequenceID;                                                              /*!< @brief */
    uint64_t startPos;                                                                /*!< @brief */
    uint64_t endPos;                                                                  /*!< @brief */
    bool singleEndsStrand[genie_Strand::genie_Strand_COUNT]; /* NOLINT */             /*!< @brief */
    bool pairedEndsStrand[genie_StrandPaired::genie_StrandPaired_COUNT]; /* NOLINT */ /*!< @brief */
    bool includeClippedReads[genie_ClipType::genie_ClipType_COUNT]; /* NOLINT */      /*!< @brief genie_clips */
...
struct genie_SegmentFilter {
    bool filterScope[genie_SegmentType::genie_SegmentType_COUNT]; /* NOLINT */ /*!< @brief */
