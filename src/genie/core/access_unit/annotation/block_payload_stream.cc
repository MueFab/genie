...
BlockPayloadStream::BlockPayloadStream()
    : descriptor_ID(genie::core::parameter::annotation::DescriptorID::GENOTYPE),
      block_payload_size(0),
      generic_payload{} {}

BlockPayloadStream::BlockPayloadStream(genie::core::parameter::annotation::DescriptorID _descriptorID,
