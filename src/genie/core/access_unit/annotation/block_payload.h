...
#ifndef SRC_GENIE_CORE_ACCESS_UNIT_ANNOTATION_BLOCK_PAYLOAD_H_
#define SRC_GENIE_CORE_ACCESS_UNIT_ANNOTATION_BLOCK_PAYLOAD_H_
...
#endif  // SRC_GENIE_CORE_ACCESS_UNIT_ANNOTATION_BLOCK_PAYLOAD_H_
