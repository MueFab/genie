...
#ifndef SRC_GENIE_CORE_VARIANT_SITE_RECORD_RECORD_H_
#define SRC_GENIE_CORE_VARIANT_SITE_RECORD_RECORD_H_
// ---------------------------------------------------------------------------------------------------------------------
 ...
 public:
    ...
    void Read(util::BitReader& reader) {
        ...
        for (auto i = 0; i < alt_count; ++i) {
            ...
            auto alt_type = static_cast<DataType>(reader.ReadAlignedInt<uint8_t>());
...
#endif  // SRC_GENIE_CORE_VARIANT_SITE_RECORD_RECORD_H_
