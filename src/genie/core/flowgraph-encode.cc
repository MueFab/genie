...
FlowGraphEncode::FlowGraphEncode(const size_t threads) : mgr(threads) {
...
void FlowGraphEncode::setImporter(std::unique_ptr<FormatImporter> dat, const size_t index) {
...
void FlowGraphEncode::setReadCoder(std::unique_ptr<ReadEncoder> dat, const size_t index) {
...
void FlowGraphEncode::setEntropyCoder(std::unique_ptr<EntropyEncoder> dat, const size_t index) {
...
void FlowGraphEncode::setExporter(std::unique_ptr<FormatExporterCompressed> dat, const size_t index) {
...
void FlowGraphEncode::setNameCoder(std::unique_ptr<NameEncoder> dat, const size_t index) {
...
void FlowGraphEncode::setQVCoder(std::unique_ptr<QVEncoder> dat, const size_t index) {
...
void FlowGraphEncode::stop(const bool abort) { mgr.stop(abort); }
