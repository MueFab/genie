...
core::parameter::annotation::AnnotationEncodingParameters AnnotationEncoder::Compose() {
    std::vector<core::parameter::annotation::filterData> filters;
    std::vector<std::string> features;
    std::vector<std::string> ontologyTerms;

    core::parameter::annotation::AnnotationEncodingParameters annotation_encoding_parameters(
...
void AnnotationEncoder::setAttributes(
    std::map<std::string, core::parameter::annotation::AttributeData>& info) {
    ...
    for (auto it = info.begin(); it != info.end(); ++it) {
        ...
        core::parameter::annotation::AttributeParameterSet attributeParameterSet(
