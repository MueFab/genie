...
core::record::annotation_parameter_set::Record ParameterSetComposer::Compose(
    ...
    std::vector<core::record::annotation_parameter_set::TileConfiguration> tile_configurations;

    tile_configurations.emplace_back(core::record::annotation_parameter_set::TileConfiguration{
