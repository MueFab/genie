...
void TrackAnnotation::parseInfoTags(std::string& recordInputFileName) {
...
TrackUnits TrackAnnotation::parseTrack(std::ifstream& inputfile) {
...
void TrackAnnotation::setInfoFields(std::string jsonFileName) {
