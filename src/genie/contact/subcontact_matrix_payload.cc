...
[[maybe_unused]] uint8_t SubcontactMatrixPayload::GetChr1ID() const { return chr1_ID_; }

// ---------------------------------------------------------------------------------------------------------------------

[[maybe_unused]] uint8_t SubcontactMatrixPayload::GetChr2ID() const { return chr2_ID_; }
