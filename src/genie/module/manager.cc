...
void detect() {
    ...
    indPark.registerConstructor<core::parameter::desc_pres::DecoderRegular>(entropy::zstd::DecoderRegular::MODE_ZSTD,
                                                                            &entropy::zstd::DecoderRegular::create);
    indPark.registerConstructor<core::parameter::desc_pres::DecoderRegular>(entropy::lzma::DecoderRegular::MODE_LZMA,
                                                                            &entropy::lzma::DecoderRegular::create);
    indPark.registerConstructor<core::parameter::desc_pres::DecoderRegular>(entropy::bsc::DecoderRegular::MODE_BSC,
