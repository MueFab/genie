 ...
 * @details The `Box` class serves as an abstract base class for different box types in the MPEG-G format.
 *          Derived classes need to implement methods for serialization, deserialization, and debugging.
 ...
 * @details Provides basic functionality for managing the structure of boxes and printing debug information.
 *          All derived classes must implement the `write` method to define how the box is serialized.
 */
class Box {
 protected:
    /**
