...
#ifndef SRC_GENIE_FORMAT_SAM_SAM_SAM_TO_MGREC_SORTER_H_
#define SRC_GENIE_FORMAT_SAM_SAM_SAM_TO_MGREC_SORTER_H_
...
#endif  // SRC_GENIE_FORMAT_SAM_SAM_SAM_TO_MGREC_SORTER_H_
