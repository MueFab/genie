...
DescriptorStreamHeader::DescriptorStreamHeader()
    : descriptor_ID(0), class_ID(core::record::ClassType::NONE), num_blocks(0) {}

// ---------------------------------------------------------------------------------------------------------------------

DescriptorStreamHeader::DescriptorStreamHeader(util::BitReader& reader, FileHeader&, size_t, size_t) {
    /// reserved u(1)
    reader.read_b(1);
