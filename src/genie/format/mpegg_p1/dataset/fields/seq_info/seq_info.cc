...
SequenceConfig::SequenceConfig() : reference_ID(0), seq_IDs(), seq_blocks(), thress() {}

// ---------------------------------------------------------------------------------------------------------------------

SequenceConfig::SequenceConfig(uint8_t _ref_ID) : reference_ID(_ref_ID), seq_IDs(), seq_blocks(), thress() {}
...
void SequenceConfig::setRefID(uint8_t _ref_ID) { reference_ID = _ref_ID; }
...
void SequenceConfig::write(util::BitWriter& writer) const {
    UTILS_DIE_IF(!isValid(), "seq_count and size of thres[] are different!");
