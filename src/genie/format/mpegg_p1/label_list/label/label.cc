...
void Label::addDatasetInfo(DatasetInfo&& _ds_info) {
    dataset_infos.push_back(std::move(_ds_info));
}
...
void Label::setDatasetInfos(std::vector<DatasetInfo>&& _ds_infos) {
    dataset_infos = _ds_infos;
}
