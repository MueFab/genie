...
#ifndef SRC_GENIE_LIKELIHOOD_LIKELIHOOD_CODER_STD_H_
#define SRC_GENIE_LIKELIHOOD_LIKELIHOOD_CODER_STD_H_
...
#endif  // SRC_GENIE_LIKELIHOOD_LIKELIHOOD_CODER_STD_H_
