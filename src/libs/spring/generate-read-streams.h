...
std::unique_ptr<MpeggRawAu> generate_read_streams(const std::string &temp_dir,
                           const compression_params &cp,
                           util::FastqStats *stats);

std::unique_ptr<MpeggRawAu> generate_read_streams_se(const std::string &temp_dir,
                              const compression_params &cp,
                              util::FastqStats *stats);

std::unique_ptr<MpeggRawAu> generate_read_streams_pe(const std::string &temp_dir,
                              const compression_params &cp,
                              util::FastqStats *stats);
