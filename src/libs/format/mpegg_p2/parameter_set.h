...
class ParameterSet : public DataUnit {
   public:
    ...
    const ParameterSetCrps &getParameterSetCrps() const { return *parameter_set_crps; }

    size_t getNumberTemplateSegments() const { return number_of_template_segments_minus1 + 1; }
