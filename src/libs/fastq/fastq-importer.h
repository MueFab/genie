 ...
 */
class FastqImporter : public util::Source<std::unique_ptr<genie::mpegg_rec::MpeggChunk>>, public util::OriginalSource {
   private:
     ...
     */
    static genie::mpegg_rec::MpeggRecord buildRecord(std::vector<std::array<std::string, LINES_PER_RECORD>> data);
