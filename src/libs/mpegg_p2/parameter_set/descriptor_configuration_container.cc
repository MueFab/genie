...
DescriptorConfigurationContainer::DescriptorConfigurationContainer(size_t num_classes, genie::GenDesc desc,
...
const DescriptorConfiguration* DescriptorConfigurationContainer::getConfig() const { return descriptor_configurations.front().get(); }
const DescriptorConfiguration* DescriptorConfigurationContainer::getConfig(uint8_t index) const { return descriptor_configurations[index].get(); }
...
std::unique_ptr<DescriptorConfigurationContainer> DescriptorConfigurationContainer::clone() const {
