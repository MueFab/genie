...
#include "mpegg_p2/parameter_set/descriptor_configuration_present/decoder_configuration.h"
...
class DecoderConfigurationCabac : public DecoderConfiguration {
   ...
   public:
    explicit DecoderConfigurationCabac(genie::GenDesc _desc);

    explicit DecoderConfigurationCabac(genie::GenDesc _desc, util::BitReader &reader);
