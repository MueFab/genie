...
MpeggRawAu::SubDescriptor::SubDescriptor(util::DataBlock d, GenSubIndex _id)
...
util::DataBlock &&MpeggRawAu::SubDescriptor::move() { return std::move(data); }
...
MpeggRawAu::MpeggRawAu(mpegg_p2::ParameterSet &&set, size_t _numRecords)
...
void MpeggRawAu::setParameters(mpegg_p2::ParameterSet &&_parameters) { parameters = std::move(_parameters); }

// ---------------------------------------------------------------------------------------------------------------------

const mpegg_p2::ParameterSet &MpeggRawAu::getParameters() const { return parameters; }

// ---------------------------------------------------------------------------------------------------------------------

mpegg_p2::ParameterSet &MpeggRawAu::getParameters() { return parameters; }

// ---------------------------------------------------------------------------------------------------------------------

mpegg_p2::ParameterSet &&MpeggRawAu::moveParameters() { return std::move(parameters); }
