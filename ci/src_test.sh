...
echo "Cpplint..."
cpplint --recursive --quiet --linelength=120 --filter=-readability/casting,-whitespace/indent_namespace,-runtime/references $git_root_dir/src || { echo 'Cpplint failed!' ; exit 1; }
echo "Cppcheck..."
