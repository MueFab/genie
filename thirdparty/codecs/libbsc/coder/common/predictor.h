...
public:
    ...
    {
        probability = probability + (short)(((4096 - threshold - probability) * adaptationRate) >> 12);
    };

    static INLINE void UpdateBit1(short & probability, const int threshold, const int adaptationRate)
    {
        probability = probability - (short)(((probability - threshold) * adaptationRate) >> 12);
    };

    template <int R> static INLINE void UpdateBit(unsigned int bit, short & probability, const int threshold0, const int threshold1)
    {
        probability = probability - (short)((probability - (bit ? threshold1 : threshold0)) >> R);
    }
