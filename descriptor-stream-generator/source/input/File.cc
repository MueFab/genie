...
/**
 *  @file File.h
 *  @brief File input/output implementation
 *  @author Jan Voges
 *  @bug No known bugs
 */
...
size_t File::writeUint32(const uint32_t dword)
{
    ...
    numWrittenBytes += writeByte((unsigned char)(dword >> 24) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(dword >> 16) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(dword >>  8) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(dword)       & 0xFF);
...
size_t File::writeUint64(const uint64_t qword)
{
    ...
    numWrittenBytes += writeByte((unsigned char)(qword >> 56) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(qword >> 48) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(qword >> 40) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(qword >> 32) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(qword >> 24) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(qword >> 16) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(qword >>  8) & 0xFF);
    numWrittenBytes += writeByte((unsigned char)(qword)       & 0xFF);
