...
int  initSignatureArbitraryLengthInteger(SignatureInputArbitraryLengthInteger *signatureInputArbitraryLengthInteger, char *data, uint32_t dataSizeInBits);
...
int oneSymbolLeftArbitraryLengthInteger(SignatureInputArbitraryLengthInteger* signatureInputArbitraryLengthInteger, uint8_t lengthSymbol);
...
uint8_t getSymbolArbitraryLengthInteger(SignatureInputArbitraryLengthInteger *signatureInputArbitraryLengthInteger, uint8_t lengthSymbol);
