    ...
    namespace desc_conf_pres {
        namespace cabac {
            CabacBinarization::CabacBinarization(
                    const CabacBinarizationParameters::BinarizationId &_binarization_ID,
            ...
            CabacBinarization::CabacBinarization() : CabacBinarization(
                    CabacBinarizationParameters::BinarizationId::BINARY_CODING,
                    make_unique<CabacBinarizationParameters>(CabacBinarizationParameters::BinarizationId::BINARY_CODING,
                                                             0)
            ) {
            ...
            void
            CabacBinarization::setContextParameters(std::unique_ptr<CabacContextParameters> _cabac_context_parameters) {
                bypass_flag = false;
