...
namespace format {
    namespace desc_conf_pres {
        namespace cabac {
            TransformSubseqParameters::TransformSubseqParameters() : TransformSubseqParameters(
                    TransformIdSubseq::NO_TRANSFORM, 0) {
            ...
            TransformSubseqParameters::TransformSubseqParameters(
                    const TransformIdSubseq &_transform_ID_subseq,
                    uint16_t param
