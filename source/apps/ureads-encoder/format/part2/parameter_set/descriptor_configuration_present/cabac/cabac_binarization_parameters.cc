...
namespace format {
    namespace desc_conf_pres {
        namespace cabac {
            ...
            CabacBinarizationParameters::CabacBinarizationParameters() : CabacBinarizationParameters(
                    BinarizationId::BINARY_CODING, 0) {
            ...
            CabacBinarizationParameters::CabacBinarizationParameters(
                    const BinarizationId &_binarization_id,
                    uint8_t param
            ) : cmax(nullptr),
                cmax_teg(nullptr),
                cmax_dtu(nullptr),
