...
namespace format {
    namespace qv_coding1 {
        ...
        QvCodingConfig1::QvCodingConfig1(QvpsPresetId _qvps_preset_ID, bool _reverse_flag) : QvCodingConfig(
                QvCodingMode::ONE, _reverse_flag), qvps_flag(false), parameter_set_qvps(nullptr) {
