...
int main(int argc, char **argv) {
    ...
    file_contents1.assign((std::istreambuf_iterator<char>(t1)), std::istreambuf_iterator<char>());
    ...
    for (size_t i = 0; i < 1000; ++i) std::cout << file_contents[i];
    std::cout << std::endl;
    ...
    while (track(0) < initial_bitcount && iterations < 4) {
        ...
        if (du.data_unit_type == 1) {
            ...
            */
            ...
            std::cout << "Unknown data_unit_type: " << du.data_unit_type << std::endl;
    }
