...
#include "DataStructures/encoding-parameters.h"
#include "DataStructures/from-file.h"
#include "classes-set.h"
#include "tree-uint64.h"
#include "vector-uint64.h"
#include "vector.h"
...
Block* initBlockWithHeaderPayloadInMemory(uint8_t descriptorId, uint32_t payloadSize, const char* payloadInMemory);
