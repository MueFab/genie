...
int initializeDescriptorTreeNode(
        ldns_rbnode_t **descriptorTreeNode,
        uint8_t descriptorId
){
    DescriptorTreeNodeKey* pClassTreeNodeKey =
            (DescriptorTreeNodeKey*)malloc(sizeof(DescriptorTreeNodeKey));
...
int descriptorTreeNodeCompareFunction(const void *thisNode, const void *thatNode){
    return descriptorTreeNodeCompareFunctionCasted(
            (const DescriptorTreeNodeKey *) thisNode,
            (const DescriptorTreeNodeKey *) thatNode
    );
}
int descriptorTreeNodeCompareFunctionCasted(
        const DescriptorTreeNodeKey *thisNode,
        const DescriptorTreeNodeKey *thatNode
){
