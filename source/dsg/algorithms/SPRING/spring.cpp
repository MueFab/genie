...
void call_reorder(std::string &working_dir, int max_readlen, int num_thr)
{
	...
	switch (bitset_size_reorder) {
		case 64: reorder_main<64>(working_dir, max_readlen, num_thr);
			 break;
		case 128: reorder_main<128>(working_dir, max_readlen, num_thr);
			 break;
		case 192: reorder_main<192>(working_dir, max_readlen, num_thr);
			 break;
		case 256: reorder_main<256>(working_dir, max_readlen, num_thr);
			 break;
		case 320: reorder_main<320>(working_dir, max_readlen, num_thr);
			 break;
		case 384: reorder_main<384>(working_dir, max_readlen, num_thr);
			 break;
		case 448: reorder_main<448>(working_dir, max_readlen, num_thr);
			 break;
...
void call_encoder(std::string &working_dir, int max_readlen, int num_thr)
{
	...
	switch (bitset_size_encoder) {
		case 64: encoder_main<64>(working_dir, max_readlen, num_thr);
			 break;
		case 128: encoder_main<128>(working_dir, max_readlen, num_thr);
			 break;
		case 192: encoder_main<192>(working_dir, max_readlen, num_thr);
			 break;
		case 256: encoder_main<256>(working_dir, max_readlen, num_thr);
			 break;
		case 320: encoder_main<320>(working_dir, max_readlen, num_thr);
			 break;
		case 384: encoder_main<384>(working_dir, max_readlen, num_thr);
			 break;
		case 448: encoder_main<448>(working_dir, max_readlen, num_thr);
			 break;
		case 512: encoder_main<512>(working_dir, max_readlen, num_thr);
			 break;
		case 576: encoder_main<576>(working_dir, max_readlen, num_thr);
			 break;
		case 640: encoder_main<640>(working_dir, max_readlen, num_thr);
			 break;
		case 704: encoder_main<704>(working_dir, max_readlen, num_thr);
			 break;
