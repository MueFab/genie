...
#pragma omp parallel
  {
    ...
    for (int tid_e = tid * num_thr_e / num_thr;
      ...
      comp_info.fcomp =
          fopen((infile_id + "." + std::to_string(tid_e)).c_str(), "r");
      comp_info.f_id =
          fopen((outfile_id + "." + std::to_string(tid_e)).c_str(), "w");
...
#pragma omp parallel
  {
    ...
    for (int tid_e = tid * num_thr_e / num_thr;
      ...
      std::string input_file_string =
          (infile_quality + "." + std::to_string(tid_e));
      ...
      std::string output_file_string =
          (outfile_quality + "." + std::to_string(tid_e));
